...
TEST(Staff, constructor_correctDataEmployeeWithPesel)
{
    std::string name("Jan");
    ...
    Staff::Staff worker(name, seconddName, email, password, pesel, position);
...
TEST(Staff, constructor_correctDataEmployeeWithIDNumber)
{
    std::string name("Jan");
    std::string seconddName("Kowalski");
    std::string email("jan.kowalski@gmail.com");
    ...
    Staff::Position position = Staff::Position::receptionist;
    Staff::Staff worker(name, seconddName, email, password, IDNumber, position);
    auto temp = worker.get();
...
TEST(Staff, constructor_emptyName)
{
    std::string name("");
    std::string seconddName("Kowalski");
    std::string email("jan.kowalski@gmail.com");
...
TEST(Staff, constructor_emptySecondName)
{
    std::string name("Jan");
...
TEST(Staff, constructor_emptyEmail)
{
    std::string name("Jan");
    std::string seconddName("Kowalski");
    std::string email("");
...
TEST(Staff, constructor_wrongEmail)
{
    std::string name("Jan");
    std::string seconddName("Kowalski");
...
TEST(Staff, constructor_wrongPassword)
{
    std::string name("Jan");
    std::string seconddName("Kowalski");
    std::string email("jan.kowalski@gmail.com");
...
TEST(Staff, constructor_emptyPassword)
{
    std::string name("Jan");
    std::string seconddName("Kowalski");
    std::string email("jan.kowalski@gmail.com");
...
TEST(Staff, constructor_wrongIDNumber)
{
    std::string name("Jan");
    std::string seconddName("Kowalski");
    std::string email("jan.kowalski@gmail.com");
...
TEST(Staff, constructor_emptyIDNumber)
{
    std::string name("Jan");
    std::string seconddName("Kowalski");
    std::string email("jan.kowalski@gmail.com");
...
TEST(Staff, constructor_wrongPesel)
{
    std::string name("Jan");
    std::string seconddName("Kowalski");
    std::string email("jan.kowalski@gmail.com");
...
TEST(Staff, constructor_emptyPesel)
{
    std::string name("Jan");
    std::string seconddName("Kowalski");
    std::string email("jan.kowalski@gmail.com");
